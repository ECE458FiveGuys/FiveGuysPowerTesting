...
class SelectServiceTestCase(TestCase):
    ...
    def test_select_all_models_sorting_happy_case(self):
        ...
        model2 = EquipmentModel.objects.create(vendor="vendor2", model_number="model_number", description="description",
        ...
        model = EquipmentModel.objects.create(vendor="vendor", model_number="model_number", description="description",
                                              comment="comment", calibration_frequency=1)
        model3 = EquipmentModel.objects.create(vendor="vendor3", model_number="model_number", description="description",
                                               comment="comment", calibration_frequency=1)
