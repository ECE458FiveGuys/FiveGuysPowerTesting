...
class VendorAutoCompleteTestCase(EndpointTestCase):
    def test_vendor_auto_complete_happy_case(self):
        ...
        Model.objects.create(vendor="vendor2", model_number="model_number", description="description",
                             comment="comment", calibration_frequency=timedelta(seconds=1))
        Model.objects.create(vendor="vendor3", model_number="model_number", description="description",
                             comment="comment", calibration_frequency=timedelta(seconds=1))
